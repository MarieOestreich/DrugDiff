...
class LatentDiffusion(pl.LightningModule):
    ...
    def __init__(self,
        ...
        with open(FILE_PATH + '/../../data/guacamol/'+'symbol_to_idx.pickle', "rb") as input_file:
            self.symbol_to_idx = pickle.load(input_file)

        with open(FILE_PATH + '/../../data/guacamol/'+'idx_to_symbol.pickle', "rb") as input_file:
            self.idx_to_symbol = pickle.load(input_file)

        with open(FILE_PATH + '/../../data/guacamol/'+'dataset_max_len.pickle', "rb") as input_file:

            self.max_len = pickle.load(input_file)
   
        # Initialize the VAE model
        self.vae = VAE(max_len=109, vocab_len=96, latent_dim=1024, embedding_dim=64) 
        print(self.vae)
